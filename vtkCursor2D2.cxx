...
vtkCursor2D2::vtkCursor2D2()
{
  ...
  this->SetXAxisColor(green);
  this->SetYAxisColor(blue);
  this->SetOutlineColor(yellow);
  ...
  vtkInformationVector *outputVector)
{
  ...
  if ( this->Point ) 
    {
    colors->InsertNextTupleValue(this->PointColor);
  ...
  if ( this->Axes ) 
    {
    colors->InsertNextTupleValue(this->XAxisColor);
    colors->InsertNextTupleValue(this->XAxisColor);
    
    colors->InsertNextTupleValue(this->YAxisColor);
    colors->InsertNextTupleValue(this->YAxisColor);
  ...
  if ( this->Outline ) 
    {
    colors->InsertNextTupleValue(this->OutlineColor);
...
void vtkCursor2D2::SetModelBounds(double xmin, double xmax, double ymin, double ymax,
...
//---------------------------------------------------------------------------
void vtkCursor2D2::SetFocalPoint(double x[3])
{
...
//---------------------------------------------------------------------------
void vtkCursor2D2::SetModelBounds(double bounds[6])
{
...
//---------------------------------------------------------------------------
void vtkCursor2D2::PrintSelf(ostream& os, vtkIndent indent)
{
